...
library(signal)
library(numbers)
source("/Users/ryo/Documents/R/R_study/FDN/had_matrix.R")
setwd("/Users/ryo/Documents/R/R_studyFDN//input")
...
for (fname in fnames){
  ...
  setwd("/Users/ryo/Documents/R/R_study/FDN/output/matrix")
